...
function crossLine(l1, l2) {
    var dx1 = l1[1][0] - l1[0][0], dy1 = l1[1][1] - l1[0][1], dx2 = l2[1][0] - l2[0][0], dy2 = l2[1][1] - l2[0][1], x = dy1 * dx2 - dy2 * dx1;
        ...
        if (allElems[i].id == elem.id) {
            ...
            for (var j = 0; j < allElems[i].way.length; j++) {
                for (var k = 0; k < elem.way.length; k++) {
                    var lk = k + 1;
                    var lj = j + 1;
                    if (lk >= elem.way.length) {
                        lk = 0;
                    }
                    if (lj >= allElems[i].way.length) {
                        lj = 0;
                    }
